                        ...
                        <div class="card shadow-lg border-0">
                            <div class="card-body checkout-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="apartement" id="apartement" class="form-control"
                                                ...
                                                value="{{ !empty($customerAddress) ? $customerAddress->apartement : '' }}">
                                            <p></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <p>Notes<span class="text-danger">*</span></p>
                                        <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group apply-coupon mt-4">
                            <input type="text" placeholder="Coupon Code" class="form-control" id="discount_code"
                                name="discount_code">
                            <button class="btn btn-dark" type="button" id="apply">Apply Coupon</button>
                        </div>
                        ...
                        <div class="card payment-form ">
                            ...
                            <div class="form-check">
                                <input checked type="radio" id="payment_1" name="payment_method" value="cod">
                                <label for="payment_1" class="form-check-label">COD</label>
                            </div>

                            <div class="form-check">
                                <input type="radio" id="payment_2" name="payment_method" value="transfer">
                                <label for="payment_2" class="form-check-label">KuPay Transfer</label>
                            </div>
