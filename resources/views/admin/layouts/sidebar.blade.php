<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="{{route('admin.dasboard')}}" class="nav-link {{ (request()->is('admin/dashboard*')) ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('shipping.create') }}" class="nav-link {{ (request()->is('admin/shipping*')) ? 'active' : '' }}">
                        <!-- <i class="nav-icon fas fa-tag"></i> -->
