...
@section('content')
    ...
    <section class="content">
        <!-- Default box -->
        <form action="" method="" name="productForm" id="productForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input value="{{$product->size}}" type="text" name="size" id="size" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input value="{{$product->color}}" type="text" name="color" id="color" class="form-control"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="sub_category" id="sub_category" class="form-control">
                                        <option value="">Select a Sub Categories</option>
